...
public:
	...
	*/
	virtual void set_process_attributes(ProcessID pid, Attribute * att, Value & value) = 0;
	virtual Value & lookup_process_attribute(ProcessID pid, Attribute * att) = 0;

	virtual void set_component_attributes(ComponentID cid, Attribute * att, Value & value) = 0;
	...
	virtual uint32_t create_instance_mapping(const string & value) = 0;
