/**
 * @file    attribute.h
 *          Header file for the data type @em attribute
 *          in the SIOX ontology interface
 *
...
#ifndef siox_ONT_ATT_H
#define siox_ONT_ATT_H
 ...
 * An attribute type
 *
 * Describes an attribute of either a component, an activity or a remote call.
 */
struct siox_attribute {
    const char * name;
    enum siox_ont_storage_type storage_type;    
};
typedef struct siox_attribute siox_attribute;
