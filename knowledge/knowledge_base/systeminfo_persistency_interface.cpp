...
*/
SioxNode * DBLayer::getNodeByHWID(char* hwid) {
...
*/
storage_device * DBLayer::updateStorageDevice(storage_device * new_storage_device) {
...
*/
filesystem * DBLayer::getFilesystemByUID(unsigned int uid) {
...
*/
filesystem * DBLayer::updateFilesystem(filesystem * new_filesystem) {
