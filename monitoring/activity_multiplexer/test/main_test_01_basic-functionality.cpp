/**
 * Test: Multiplexer: Basic functionality
 *
 * Setup:
 * A single Multiplexer, multiple plugins, multiple layers
 *
 * Assert:
 * after registration activities are recieved
 * after unregistration no activity is received
 *
