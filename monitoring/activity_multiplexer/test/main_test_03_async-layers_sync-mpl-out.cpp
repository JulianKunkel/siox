/**
 * Test: Multiplexer: Async Layers are synced by mpl
 * 
 * Situation:
 * Two layers produce activities in an async way. When passed to the multiplexer they
 * become synced (at least in storage).
 *
 * Assert:
 * ?
 *
