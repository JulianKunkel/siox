...
int main( int argc, char const * argv[] )
{
	...
	StatisticsMultiplexerPlugin * ap = core::module_create_instance<StatisticsMultiplexerPlugin>( "", "siox-monitoring-statisticsMultiplexerPlugin-FileWriter", STATISTICS_MULTIPLEXER_PLUGIN_INTERFACE );
