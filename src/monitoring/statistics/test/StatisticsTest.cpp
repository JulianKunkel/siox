...
//		StatisticsDescription description( ontology->lookup_attribute_by_name( kStatisticsDomain, "test/weather" ).aID, {{"node", LOCAL_HOSTNAME}, {"tschaka", "test2"}} );
		StatisticsDescription description( ontology->lookup_attribute_by_name( kStatisticsDomain, "test/weather" ).aID, topology->lookupObjectByPath( "@localhost/weather-station:0" ).id() );
