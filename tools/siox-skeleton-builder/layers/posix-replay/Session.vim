...
silent only
cd ~/Sync/Uni/wr/siox/tools/siox-skeleton-builder/layers/posix-replay
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 template.py
badd +0 ../../lib/styles/sparse-dlsym.py
badd +0 ../../lib/styles/sparse-wrap.py
argglobal
silent! argdel *
argadd template.py
set stal=2
...
silent! normal! zE
let s:l = 157 - ((37 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
157
normal! 0
tabedit ../../lib/styles/sparse-dlsym.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
1
normal! 0
tabedit ../../lib/styles/sparse-wrap.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
